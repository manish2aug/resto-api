...
@Entity
@Table(
        name = "regional_influence",
        schema = "catalog",
        catalog = "resto_db"
)
public class CatalogRegionalInfluenceEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogRegionalInfluenceEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogRegionalInfluenceEntity that = (CatalogRegionalInfluenceEntity)o;
    ...
    @OneToMany(
            mappedBy = "regionalInfluenceByRegionalInfluenceId"
    )
