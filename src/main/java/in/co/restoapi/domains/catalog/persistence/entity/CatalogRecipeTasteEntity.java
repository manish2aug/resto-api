...
public class CatalogRecipeTasteEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogRecipeTasteEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogRecipeTasteEntity that = (CatalogRecipeTasteEntity)o;
