...
@Entity
@Table(
        name = "recipe_consistency",
        schema = "catalog",
        catalog = "resto_db"
)
public class CatalogRecipeConsistencyEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogRecipeConsistencyEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogRecipeConsistencyEntity that = (CatalogRecipeConsistencyEntity)o;
    ...
    @OneToMany(
            mappedBy = "recipeConsistencyByConsistencyId"
    )
