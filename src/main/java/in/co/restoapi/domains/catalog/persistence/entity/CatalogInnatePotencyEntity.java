...
public class CatalogInnatePotencyEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogInnatePotencyEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogInnatePotencyEntity that = (CatalogInnatePotencyEntity)o;
    ...
    @OneToMany(
            mappedBy = "innatePotencyByInnatePotencyId"
    )
