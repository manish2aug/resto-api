...
public class CatalogCookingPotEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogCookingPotEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogCookingPotEntity that = (CatalogCookingPotEntity)o;
    ...
    @OneToMany(
            mappedBy = "cookingPotByCockingPotId"
    )
