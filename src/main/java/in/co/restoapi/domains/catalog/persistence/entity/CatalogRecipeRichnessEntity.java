...
@Entity
@Table(
        name = "recipe_richness",
        schema = "catalog",
        catalog = "resto_db"
)
public class CatalogRecipeRichnessEntity {
    private Long id;
    private String name;
    private String code;
    ...
    public CatalogRecipeRichnessEntity() {
    }
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            CatalogRecipeRichnessEntity that = (CatalogRecipeRichnessEntity)o;
    ...
    @OneToMany(
            mappedBy = "recipeRichnessByRichnessId"
    )
